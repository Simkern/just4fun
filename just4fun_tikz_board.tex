    ...
    \begin{tikzpicture}
    	...
    	\foreach \x in {0,...,5} {
    		\foreach \y in {0,...,5} {
        		...
        		{\pgfmathparse{\nums[\x+6*\y]};
        		\node[rotate= 90, text=white] at (ce\x\y.east)  {\textbf{\pgfmathresult}};
        		\node[rotate=180, text=white] at (cn\x\y.north) {\textbf{\pgfmathresult}};
        		\node[rotate=-90, text=white] at (cw\x\y.west)  {\textbf{\pgfmathresult}};
        		\node[text=white] at (cs\x\y.south) {\textbf{\pgfmathresult}};
        		}
        	};
        };
    \end{tikzpicture}
